...
{
    switch (pin) {
        case BUTTON_UP_PIN:     return UP;
        case BUTTON_DOWN_PIN:   return DOWN;
        case BUTTON_LEFT_PIN:   return LEFT;
        case BUTTON_RIGHT_PIN:  return RIGHT;
        case BUTTON_CENTER_PIN: return MIDDLE;
        default:                return -1; 
    }
}
